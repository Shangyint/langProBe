...
RAGQAGeneratorCriticFuser_20 = program.GeneratorCriticFuser(basic_signature, n=20)
RAGQAGeneratorCriticRanker = program.GeneratorCriticRanker(basic_signature)
RAGQAGeneratorCriticRanker_20 = program.GeneratorCriticRanker(basic_signature, n=20)
