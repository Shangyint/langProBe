...
class RAG(dspy.Module):
    def __init__(self, num_docs=5):
        ...
        self.index = torch.load('langProBe/RAGQAArenaTech/data/index.pt', weights_only=True)
    ...
    def search(self, query, k=5):
        ...
        topK = [dict(score=score.item(), **self.corpus[idx]) for idx, score in zip(topk_indices, topk_scores)]
