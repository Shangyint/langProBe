...
class AppWorldClient:
    ...
    def initialize(self, experiment_name: str, task_id: str):
        args = AppWorldInitializeArgs(experiment_name=experiment_name, task_id=task_id).__dict__
    ...
    def evaluate(self, task_id, suppress_errors=False, report=False):
        data = {"task_id": task_id, "suppress_errors": suppress_errors, "report": report}
